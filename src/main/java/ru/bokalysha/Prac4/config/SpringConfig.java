package ru.bokalysha.Prac4.config;
 ...
 */
@Configuration
@ComponentScan("ru.bokalysha.Prac4")
...
public class SpringConfig {
     ...
     *
     * @return DataSource объект с настроенными параметрами подключения.
     */
    @Bean
     ...
     *
     * @return JdbcTemplate объект, сконфигурированный для использования DataSource.
     */
    @Bean
